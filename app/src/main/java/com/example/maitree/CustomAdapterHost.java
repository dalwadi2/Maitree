...
public class CustomAdapterHost extends BaseAdapter {
    ...
    public CustomAdapterHost(Context mainActivity, String[] prgmNameList, String[] sin) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.numer.setText(contactnuber[position]);
        holder.name.setText(contactname[position]);

        row.setId(position);

        final String aa = contactname[position];
